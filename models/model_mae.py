...
class MaskedAutoencoderDinoV2(nn.Module):
    """ Masked Autoencoder with DINO VisionTransformer backbone
    """
    def __init__(self, encoder_name='vit_base', img_size=224, patch_size=16, in_chans=3,
        ...
        self.encoder = models.dinov2_pretrain_dict[encoder_name](
